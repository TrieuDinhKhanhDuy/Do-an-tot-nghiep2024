...
<div className="gioithieu-container">
    ...
    <div className="gioithieu-content">
        <p>Công ty CP Thương mại và du lịch Hà Lan được thành lập năm 2003. Khởi đầu từ một Công ty quy mô nhỏ với dịch vụ vận tải hành khách công cộng đầu tiên ở Tỉnh Thái Nguyên với 10 chiếc xe được khai trương vào ngày 30/10/2003. Trải qua 20 năm phát triển, lấy tiên phong và sáng tạo để làm đòn bẩy, lấy con người là giá trị cốt lõi, lấy cộng đồng làm giá trị tinh thần và xây dựng.  Hiện nay, Hà Lan là đơn vị hàng đầu trong các lĩnh vực vận tải:<br />
     – Dịch vụ vận tải hành khách công cộng bằng xe buýt (thương hiệu Halanbus)<br />
     – Dịch vụ vận tải hành khách bằng xe hợp đồng ( thương hiệu Halan limousine)<br />
     – Dịch vụ vận tải hàng hoá ( thương hiệu Halan Express)<br />
     – Dịch vụ kinh doanh xăng dầu<br />
     – Dịch vụ sửa chữa, đại tu và cung cấp vật tư ô tô ( thương hiệu Hà Lan Service)<br />
     – Bến xe Định Hoá<br />
     – Taxi Hà Lan<br /><br />

Với gần 700 lao động và gần 300 phương tiện, đồng hành với hơn 10 triệu hành trình mỗi năm, Hà Lan đã và đang đổi mới mạnh mẽ hơn nữa để nâng cao hiệu quả, sức cạnh tranh của doanh nghiệp thị trường trong nước và Tỉnh Thái Nguyên.
<br /><br />
Cùng với việc đầu tư phát triển, mở rộng mạng lưới, tuyến mới, lộ trình mới và đầu tư cơ sở vật chất, những dòng xe chất lượng cao. Hà Lan còn tập trung và đẩy mạnh áp dụng công nghệ và chuyển đổi số vào hoạt động sản xuất kinh doanh.
<br /><br />
Hai năm đồng hành cùng tỉnh nhà và đất nước chống chọi với đại dịch COVID-19, dù gặp nhiều khó khăn do thị trường dịch vụ vận tải sụt giảm nguồn thu, nhưng Công ty đã phối hợp với các công ty công nghệ xây dựng nền tảng chuyển đổi số cho vận tải, coi đó là giải pháp giúp doanh nghiệp trụ vững. Từ đó cho đến nay, Hà Lan là doanh nghiệp tiên phong đi đầu trong thực hiện chương trình chuyển đổi số tỉnh Thái Nguyên.
</p>
