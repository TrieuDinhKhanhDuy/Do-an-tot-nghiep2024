            ...
            if (matchedVoucher) {
                ...
                if (storedUser) {
                    ...
                    try {
                        ...
                        window.location.href = `/pay?id_change=${id_change}&total_old_price=${total_old_price}&start_stop_name=${start_stop_name}&end_stop_name=${end_stop_name}&userId=${data.id}&note=${data.note}&trip_id=${tripId}&bus_id=${busId}&fare=${fare}&route_id=${routeId}&time_start=${timeStart}&date=${date}&name_seat=${data?.seat}&location_start=${data?.location_start}&id_start_stop=${id_start_stop}&location_end=${data?.location_end}&id_end_stop=${id_end_stop}&name=${data?.name}&phone=${data?.phone}&email=${data?.email}&total_price=${data?.total_price}&note=${data?.note}&vouchercode=${localResult.code}&discount=${localResult.discount}`;
                    } catch (error) {
                ...
                window.location.href = `/pay?id_change=${id_change}&total_old_price=${total_old_price}&start_stop_name=${start_stop_name}&end_stop_name=${end_stop_name}&note=${data.note}&userId=${data.id}&trip_id=${tripId}&bus_id=${busId}&fare=${fare}&route_id=${routeId}&time_start=${timeStart}&date=${date}&name_seat=${data?.seat}&location_start=${data?.location_start}&id_start_stop=${id_start_stop}&location_end=${data?.location_end}&id_end_stop=${id_end_stop}&name=${data?.name}&phone=${data?.phone}&email=${data?.email}&total_price=${data?.total_price}&note=${data?.note}&vouchercode=&discount=`;
            }
        } catch (error) {
